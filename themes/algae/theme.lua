...
--wibox.container.background(wibox.container.margin(wibox.widget {theme.cpuicon, cpufreq, layout = wibox.layout.align.horizontal }, 3, 4), "#777E76"),
